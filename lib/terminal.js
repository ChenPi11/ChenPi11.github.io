...
/**
 * Convert output data to outputable data.
 *
 * @param {string} output The output data.
 * @returns {string} The outputable data.
 */
 ...
 *
 * @param {string} output The output data.
 * @returns {string} The standardized output data.
 */
...
export class TerminalApplet extends HTMLElement {
    /**
     * The title of the terminal applet.
     *
     * @type {string}
     */
    ...
    connectedCallback() {
        ...
        this.readonly = $this.attr("read-only") || true;
