 ...
 *
 * @returns {string} The preferred color scheme.
 */
 ...
 * Set the theme.
 *
 * @param {string} new_theme The new theme.
 */
export function setTheme(new_theme) {
    theme = new_theme;
    ...
    $("body").attr("data-theme", theme);
    setCookie("color-scheme", theme);
    themeChangeCallbacks.forEach(callback => callback(theme));
};

/**
 * Add a callback function for theme change.
 *
 * @param {function} callback The callback function.
 */
export function addThemeChangeCallback(callback) {
